...
BEGIN
    ...
    LOOP
        -- Get product details and lock row to prevent race conditions
        SELECT descricao, estoque INTO v_produto
    ...
    -- Note: Triggers on vendas will automatically update total and profit of the sale record
