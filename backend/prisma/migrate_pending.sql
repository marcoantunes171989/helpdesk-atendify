...
-- 7. Criar tabela de anexos de trâmites (comentários)
...
ALTER TABLE "ticket_comment_attachments" DROP CONSTRAINT IF EXISTS "ticket_comment_attachments_commentId_fkey";
