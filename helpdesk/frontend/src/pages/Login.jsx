...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f0faf4' }}>

      {/* Header verde — só no mobile */}
      {isMobile && (
        <div style={{
      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        {/* Painel esquerdo verde — só no desktop */}
        {!isMobile && (
          <div style={{
            width: '45%',
            background: 'linear-gradient(160deg, #1a7a4a 0%, #22c55e 100%)',
            ...
            <p style={{
              ...
              textAlign: 'center', lineHeight: 1.6, maxWidth: 260, margin: 0,
            }}>
        ...
        <div style={{
          ...
          <div style={{ width: '100%', maxWidth: 360 }}>
            <h2 style={{
              fontSize: isMobile ? 20 : 24, fontWeight: 700, color: '#111',
              margin: '0 0 6px', fontFamily: "'Poppins', sans-serif", letterSpacing: '-0.3px',
            }}>
              Bem-vindo de volta
            </h2>
