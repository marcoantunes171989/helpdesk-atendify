        ...
        <div style={{ padding: '0 24px' }}>
          <Form form={form} layout="vertical" onFinish={handleCreate}>
            ...
            <Form.Item name="description" label="Descrição" rules={[{ required: true, message: 'Descreva o problema' }]}>
              <TextArea rows={5} maxLength={250} showCount placeholder="Detalhe o problema com o máximo de informações possível..." style={{ resize: 'none' }} styles={{ textarea: { borderRadius: 8 } }} />
            </Form.Item>
